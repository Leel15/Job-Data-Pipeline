...
TECHNICAL_SKILLS = {
    ...
    'apache airflow', 'airflow', 'dbt', 'databricks', 'snowflake', 'azure data factory', 'adf', 'aws glue', 'aws emr', 'kinesis', 'flink', 'spark', 'pyspark', 'data engineering', 'data pipeline', 'data pipelines', 'data lake', 'data lakehouse', 'data warehouse', 'data modeling', 'etl', 'elt', 'data ingestion', 'data integration', 'data quality', 'data governance',
